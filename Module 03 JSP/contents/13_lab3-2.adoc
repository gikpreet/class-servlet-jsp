...
+
8. c:\apache-tomcat-9.8.xx\webapps\lab3-2 폴더를 Visual Studio Code에서 엽니다.
...
+
----
$ cp -r ~/Downloads/lab3-2/Starter /var/lib/tomcat9/webapps/
----
4. 웹 브라우저를 실행하여 http://localhost:8080 으로 이동하고, Manager App 버튼을 클릭합니다.
5. 로그인 창에서, 사용자 이름과 비밀번호에 admin을 입력하고 로그인합니다.
6. Tomcat 웹 애플리케이션에서 /lab3-2 애플리케이션을 확인합니다.
...
link:./12_response.adoc[이전: response 객체] +
link:./14_application.adoc[이전: application 객체]